...
To use the widget you must include _jQuery_ and _jQuery UI_ bundle (including `ui.sys`, `ui.widget`, `ui.button`, 
	...
	_initUploader: function() {
		...
		uploader.bind('FilesAdded', function(up, files) {
			...
			if (self.options.autostart) {
				// set a little delay to make sure that QueueChanged triggered by the sys has time to complete
				setTimeout(function() {
					self.start();
				}, 10);
			}
