...
oj.Config.getResourceUrl = function(relativePath)
{
  ...
  if (oj.__isAmdLoaderPresent())
  {
    // : use ojs/_foo_ instead of ojs/ojcore to handle the case when ojs.sys ends up in a partition bundle
 ...
 * wants to send down, but the usual values are 'biz', 'ios', 'android', 'windows'
 */
