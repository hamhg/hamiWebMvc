...
//        this._lock(newval) ;
     ...
     /**
       ...
       *  stores it in this._data.sys.prepMoveBlk
       *
       *  The object contains :
...
//       this._emitEvent(this._data.sys.prepMoveBlk, "prepare_move", true);
         if (cb)  {
       ...
       if (check) {
          ...
          switch(!0)  {
             ...
             case (! isSelected && !isMultiple):
                 ...
                 else   //if (this._data.sys.selectMode == -1 || this._data.sys.selectMode > 0)  {
                   if (selectMode === 1)  {
                     this._deselect(ui.selected) ;            // clear the selection
                 }
...
*/
     ...
     _save_opened : function ()
     {
        ...
        // this._emitEvent(_this._data.sys.toExpand, "save_opened", true);
     },
     ...
     _start : function()
     {
       ...
       this._$container
              .delegate(".oj-tree-list ins.oj-tree-disclosure-icon", "click.ojtree",
                     function (event)  {
                       var trgt = $(event.target);
                       // if(trgt.is("ins") && event.pageY - trgt.offset().top < this.data.sys.li_height) { this.toggle_node(trgt); }
                       this["toggleExpand"](trgt);
                     }.bind(this))
