...
// When you will want to create and show TreeGrids on your page, load GridE.js.js by calling the LoadGridE() function
// The path is url of GridE.js.js file like "../Grid/GridE.js.js".
   ...
   if(!path) {
      ...
      for(var i=0;i<S.length;i++){
         if(S[i].src && S[i].src.indexOf("GridEOnDemand.js")>=0){
            path = S[i].src.replace("GridEOnDemand.js","GridE.js.js"); break;
            }
         }
