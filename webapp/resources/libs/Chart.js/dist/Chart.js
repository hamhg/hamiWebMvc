...
var Chart = require('./sys/sys.js')();

require('./sys/sys.helpers')(Chart);
require('./sys/sys.element')(Chart);
require('./sys/sys.animation')(Chart);
require('./sys/sys.controller')(Chart);
require('./sys/sys.datasetController')(Chart);
require('./sys/sys.layoutService')(Chart);
require('./sys/sys.legend')(Chart);
require('./sys/sys.plugin.js')(Chart);
require('./sys/sys.scale')(Chart);
require('./sys/sys.scaleService')(Chart);
require('./sys/sys.title')(Chart);
require('./sys/sys.tooltip')(Chart);
...
// See Chart.sys.datasetController.dataElementType
