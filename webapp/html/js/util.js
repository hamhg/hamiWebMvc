                                    ...
                                    function(event, jqxhr, settings,
                                        ...
                                        if (jqxhr.status == '500') {
                                            if (jqxhr
                                                    ...
                                                    && jqxhr.responseJSON.exceptionMsg != null
                                                    && jqxhr.responseJSON.exceptionMsg != '') {
                                                swal(
                                                        jqxhr.responseJSON.exceptionMsg,
                                                        "", "error");
                                            } else {
                                                swal(
                                                        '오류가 발생했습니다. 관리자에게 문의 바랍니다.',
                                                        "", "error");
                                            }
...
function topMenuActive() {
    var curLocation_1 = $(".nsok-page-heading > .location ").find("li").eq(1)
            .text().replace(/\s/g, ""), curLocation_2 = $(
            ".nsok-page-heading > .location ").find("li").eq(2).text().replace(
            /\s/g, ""),

    gnb = $(".nsok-gnbArea"), gnbMenu_1 = gnb.find(">li"), gnbMenu_2 = gnb
            .find(">li>ul>li");
